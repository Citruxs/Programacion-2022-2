...
public class Tablero implements Serializable{
	...
	Rey RB = new Rey(0, 4, true);
	Rey RN = new Rey(7, 3, false);
	...
	public void iniciarJuego(){
		...
		//
		//...
		//posiciones[3][3] = new Rey(3,3,true);
		//
	...
	public boolean mover(int x1, int y1, int x2, int y2, boolean turnoj){

		if (mate) {
			System.out.println("El juego se acabo");
		}
		if (Jaque) {
		...
		if (p!= null) {
			...
			if(posiciones[x1][y1].color == turnoj){
				...
				if(respuesta){
					...
					if(Jaque){
						System.out.println("Tu rey esta en peligro");
					}
					turno = !turno;
					turnoj = !turnoj;
				}
